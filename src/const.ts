...
export const WEDDING_DATE = dayjs.tz("2026-04-18 12:00", "Asia/Seoul")
...
// 예: https://map.naver.com/p/entry/place/19882195 -> 19882195
export const NMAP_PLACE_ID = 19882195

// 카카오 지도의 웨딩홀 장소 ID
// 카카오 지도 웹페이지에서 웨딩홀 검색 후 해당 장소에서 상세보기 클릭 시 URL에서 확인 가능.
// 예: https://place.map.kakao.com/10457235 -> 10457235
export const KMAP_PLACE_ID = 10457235

export const BRIDE_FULLNAME = "연윤하"
export const BRIDE_FIRSTNAME = "윤하"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "연제호"
export const BRIDE_MOTHER = "박경자"
...
export const GROOM_FULLNAME = "오재헌"
export const GROOM_FIRSTNAME = "재헌"
export const GROOM_TITLE = "장남"
export const GROOM_FATHER = "오성용"
export const GROOM_MOTHER = "유영숙"
export const GROOM_INFO = [
  {
    relation: "신랑",
    name: GROOM_FULLNAME,
    phone: "010-6564-1047",
    account: "카카오뱅크 3333030356242",
  },
  {
    relation: "신랑 어머니",
    name: GROOM_MOTHER,
